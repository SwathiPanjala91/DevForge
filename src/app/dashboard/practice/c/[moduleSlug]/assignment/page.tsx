...
export default function AssignmentShellPage({ params }: { params: Promise<{ moduleSlug: string }> | { moduleSlug: string } }) {
  const resolvedParams = React.use(params as any) as { moduleSlug: string };
  ...
  return (
    <div className="min-h-screen bg-[#0b0d14] text-gray-200 p-8 font-sans">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <Link href={`/dashboard/practice/c/${moduleSlug}`} className="text-sm text-blue-400 hover:text-blue-300 transition-colors mb-4 inline-block">
            ← Back to Module
          </Link>
          ...
          <p className="text-xl text-gray-400">Validate your knowledge of {moduleSlug} in C.</p>
        </div>
          ...
          <div className="bg-[#121520] rounded-2xl border border-gray-800 shadow-xl overflow-hidden animate-in fade-in zoom-in duration-500 relative">
            ...
            <div className="p-12 flex flex-col items-center text-center">
              ...
              <div className="bg-gradient-to-br from-amber-500/10 to-orange-600/10 border border-amber-500/30 rounded-2xl p-8 flex flex-col items-center justify-center relative overflow-hidden group mt-4">
                 ...
                 <div className="text-2xl font-extrabold text-white">C • {moduleSlug}</div>
              </div>
