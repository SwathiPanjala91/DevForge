...
export default function LabShellPage({ params }: { params: { moduleSlug: string, labId: string } }) {
    ...
    <div className="min-h-screen bg-[#090a0f] text-gray-300 flex flex-col font-sans h-screen">
      ...
      <header className="h-14 bg-[#11131c] border-b border-gray-800 flex items-center justify-between px-6 shrink-0">
        <div className="flex items-center gap-4 text-sm">
          <Link href={`/dashboard/practice/c/${params.moduleSlug}`} className="text-gray-400 hover:text-white transition-colors">
            ← Back to Module
          </Link>
          <span className="text-gray-600">|</span>
          <span className="font-semibold text-white">Lab: {params.labId}</span>
        </div>
